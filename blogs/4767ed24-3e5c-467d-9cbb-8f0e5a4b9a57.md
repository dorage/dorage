---
uuid: 4767ed24-3e5c-467d-9cbb-8f0e5a4b9a57
description: 
title: [React] useState는 어떻게 구현이 되었을까?
tags: [ React ]
...
정말 단순한 예상으로는 이렇게 구현이 되었을 것이라 생각을 하지만 실제 구현은 어떻게 되었는지 모르고 있다.
...
위 포스트 에서는 다음과 같이 simplified 한 구현을 보이고 있다.
